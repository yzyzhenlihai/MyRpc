...
const uint32_t TableStruct_RpcHeader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::RpcHeader::RpcHeader, _impl_.servicename_),
  PROTOBUF_FIELD_OFFSET(::RpcHeader::RpcHeader, _impl_.methodname_),
  PROTOBUF_FIELD_OFFSET(::RpcHeader::RpcHeader, _impl_.argsize_),
};
...
const char descriptor_table_protodef_RpcHeader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017RpcHeader.proto\022\tRpcHeader\"E\n\tRpcHeade"
...
uint8_t* RpcHeader::_InternalSerialize(
  ...
  if (this->_internal_argsize() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(3, this->_internal_argsize(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:RpcHeader.RpcHeader)
  ...
  // int32 argSize = 3;
  if (this->_internal_argsize() != 0) {
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_argsize());
  }
